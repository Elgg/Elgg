 ...
 */
	...
	'login' => "Masuk",
	'loginok' => "Anda telah masuk.",
	'loginerror' => "Kami tidak dapat memasukkan Anda. Mohon periksa kata sandi Anda dan cobalah kembali.",
	'login:empty' => "Username/email dan password diwajibkan.",
	'login:baduser' => "Tidak dapat memuat akun pengguna Anda.",
	'auth:nopams' => "Kesalahan internal. Tidak ada autentikasi pengguna yang terpasang.",

	'logout' => "Keluar",
	'logoutok' => "Anda telah keluar.",
	'logouterror' => "Kami tidak dapat mengeluarkan Anda. Mohon mencoba kembali.",
	...
	'loggedinrequired' => "Anda harus masuk untuk melihat halaman yang diminta.",
	'adminrequired' => "Anda harus sebagai administrator untuk melihat halaman yang diminta.",
	'membershiprequired' => "Anda harus menjadi anggota grup ini untuk melihat halaman yang diminta.",
	'limited_access' => "Anda tidak memiliki izin untuk melihat halaman yang diminta.",
 ...
 */
	...
	'exception:title' => "Kesalahan Fatal.",
	'exception:contact_admin' => 'Terjadi kesalahan yang tidak dapat dipulihkan dan telah dicatat. Hubungi administrator situs dengan informasi berikut:',

	'actionundefined' => "Aksi yang diminta (%s) tidak didefinisikan di dalam sistem.",
