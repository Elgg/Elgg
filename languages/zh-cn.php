...
/*
Author：chenhao、zhoushuhua
site:researchpot.com(comming soon)
version:1.0 beta
date:2018-04-11
*/
 ...
 */
    ...
    'ElggPlugin:NoPluginPackagePackage' => '插件ID %s 对应的包丢失 (guid %s)',
    'ElggPluginPackage:InvalidPlugin:MissingFile' => '文件 "%s" 丢失！',
    'ElggPluginPackage:InvalidPlugin:InvalidId' => '此插件的路径名 "%s" 必须和 manifest 配置文件中的定义一致！',
    ...
    'ElggPlugin:Exception:NoID' => '插件guid中没有ID %s!',
    ...
    'LoginException:UsernameFailure' => '登录失败，手机号/Email不存在！',
 ...
 */
    ...
    'table_columns:fromProperty:username' => '手机号',
 ...
 */
    ...
    'access' => "访问",
    'access:overridenotice' => "提示: 由于研究组设置, 该内容仅研究组成员可访问.",
 ...
 */
    ...
    'river:update:user:profile' => '%s 更新了个人信息',
 ...
 * Notifications
 */
    'notifications:usersettings' => "消息提醒设置",
    'notification:method:email' => 'Email',

    'notifications:usersettings:save:ok' => "消息提醒设置已保存.",
    'notifications:usersettings:save:fail' => "消息提醒设置保存失败.",
 ...
 */
    ...
    'registration:userexists' => '手机号已经被注册',
    'registration:usernametooshort' => '手机号不能少于%u字符.',
    'registration:usernametoolong' => '手机号太长, 不能超过%u字符.',
    'registration:passwordtooshort' => '密码不得少于%u字符T.',
    'registration:dupeemail' => '该邮箱地址已被注册.',
    'registration:invalidchars' => '对不起，你的手机号含有无效字符%s. 以下字符是无效的: %s',
    'registration:emailnotvalid' => '对不起，你输入的邮箱地址在此系统无效',
    'registration:passwordnotvalid' => '对不起，你输入的密码在此系统无效',
    'registration:usernamenotvalid' => '对不起，你输入的手机号无效',
 ...
 */
    ...
    'admin:statistics' => "统计", //'admin:statistics:overview' => '总览',
...
三个部分:
    ...
    'item:object:custom_profile_field' => '用户个人简介项',
    'item:object:file' => '文件',
 ...
 */
    ...
    'admin:plugins:set_priority:no_with_msg' => "不能重排序 %s。 错误发生: %s",
    ...
    'admin:appearance:default_widgets' => '默认组件',
 ...
 */
    ...
    'upgrade:unable_to_upgrade_info' =>
        '安装无法升级，因为在Elgg核心views路径检测到旧的视图，
 ...
 */
    ...
    'generic_comment:notification:owner:subject' => '您有新评论!',
...
%s",
    ...
    'generic_comment:notification:user:subject' => '新评论： %s',
