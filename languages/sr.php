 ...
 */
	...
	'login' => "Пријави се",
	'loginok' => "Пријављени сте.",
	'loginerror' => "Не можемо да Вас пријавимо. Проверите унете податке и покушајте поново.",
	'login:empty' => "Корисничко име/маил и лозинка су обавезни.",
	'login:baduser' => "Не може се учитати ваш кориснички налог.",
	'auth:nopams' => "Интерна грешка. Ниједан систем за аутентикацију није инсталиран.",

	'logout' => "Одјавите се",
	'logoutok' => "Одјављени сте.",
	'logouterror' => "Неможемо Вас одјавити. Пробајте поново.",
	'session_expired' => "Ваша сесија је истекла. Молимо Вас да учитате <a href='javascript:location.reload(true)'>опет</a> страницу да би сте се пријавили.",
	'session_changed_user' => "Пријављени сте као други корисник. Треба да учитате страницу <a href='javascript:location.reload(true)'>опет</a>.",

	'loggedinrequired' => "Да би сте видели захтевану страну треба да будете пријављени.",
	'adminrequired' => "Да би сте видели захтевану страницу потребно је да будете администратор.",
	'membershiprequired' => "Да би сте видели захтевану страницу потребно је да будете члан групе.",
	'limited_access' => "Немате потребне дозволе да би сте видели захтевану страницу.",
