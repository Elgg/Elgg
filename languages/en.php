 ...
 */
	...
	'admin:settings:user_data_store:data_store' => 'User data storage:',
	'admin:settings:user_data_store:data_dir' => 'Local data directory',
	'admin:settings:user_data_store:data_dir:info' => 'User data will be stored on your local server in the directory specified above',
