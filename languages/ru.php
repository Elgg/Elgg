 ...
 */
	...
	'login' => "Войти",
	'loginok' => "Вы вошли.",
	'loginerror' => "Мы не можем впустить Вас. Пожалуйста, проверьте ваши учетные данные и повторите попытку.",
	'login:empty' => "Требуются, Имя пользователя / адрес электронной почты и пароль.",
 ...
 */
	...
	'error:400:content' => 'Извините, запрос неправильный или незавершенный',
	'error:403:title' => 'Доступ запрещен',
	'error:403:content' => 'Извините, у вас нет доступа к запрошенной странице.',
 ...
 */
	...
	'autogen_password_option' => "Автоматически создать безопасный пароль?",
 ...
 */
	...
	'access:read' => "Доступ на просмотр",
	...
	'access:comments:change' => "Это обсуждение видит ограниченное количество пользователей. Вы можете его сделать более доступным другим людям.",
 ...
 */
	...
	'river:delete' => 'Удалите этот пункт активности',
	'river:delete:success' => 'Пункт активности будет удалён',
	'river:delete:fail' => 'Пункт активности не может быть удален',
	'river:delete:lack_permission' => 'У вас нет прав чтобы удалить этот пункт активности',
	...
	'river:widget:description' => "Отобразить последнюю активность",
	'river:widget:type' => "Тип активности",
	'river:widgets:friends' => 'Активность друзей',
	'river:widgets:all' => 'Вся активность',
 ...
 */
	...
	'notification:body' => 'Просмотр новой активности в 1%s',
 ...
 */
	...
	'admin:plugins:activate_all' => 'Активировать всё',
	'admin:plugins:deactivate_all' => 'Деактивировать всё',
	...
	'admin:user:label:searchbutton' => "Поиск",
 ...
 */
	...
	'river:all' => 'Вся Активность',
	'river:mine' => 'Моя активность',
	'river:owner' => 'Активность из 1%s',
