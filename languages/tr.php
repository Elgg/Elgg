 ...
 */
	...
	'loginerror' => "Girişinizi yapamadık. Kullanıcı bilgilerinizi kontrol edin ve tekrar deneyin.",
	'login:empty' => "Kullanıcı adı/e-posta ve şifre gerekli.",
	'login:baduser' => "Kullanıcı hesabınız yüzklenemedi.",
	'auth:nopams' => "İç hata. Hiçbir kullanıcı kimlik doğrulama yöntemi yüklü değil.",

	'logout' => "Çıkış yap",
	'logoutok' => "Çıkış yaptınız.",
	'logouterror' => "Çıkışınızı yapamadık. Lütfen tekrar deneyin.",
	'session_expired' => "Oturumunuz sona erdi. Lütfen <a href='javascript:location.reload(true)'> giriş yapmak için </a> sayfayı yeniden yükleyin.",
