...
%s',
	...
	'notifications:subscriptions:details:no_results' => 'Il n\'y a pas d\'abonnement détaillé à configurer.',
 ...
 */
	...
	'registration:invalidchars:route' => 'Désolé, votre identifiant contient le caractère %s qui est invalide.',
...
Comme Elgg a un grand nombre d\'accès aux fichiers cela va avoir un effet négatif sur les performances. D\'autre part l\'opcache de PHP ne peut plus mettre en cache les chemins de fichiers dans la mémoire et doit les résoudre lors de chaque accès.',
	...
	'admin:users:inactive:last_login_before' => "Afficher les utilisateurs qui ne se sont pas connectés après",
	'admin:users:inactive:last_login_before:help' => "Cela affichera également les utilisateurs qui ne se sont jamais connectés.",
	...
	'admin:site_icons:font_awesome:zip' => "Charger un fichier ZIP",
