<?php
	...
	$run_result .= <<< END
<div class="helpFiles">
<h5>Why would you want to have a profile?</h5>
...
<p><b>>> Select 'Edit this profile'</b></p>
<img src="/help/images/profile_to_do.jpg" alt="How to do it?" title="How to do it?" width="369" height="104" border="0">

<p>Fill in the fields that you want, don't worry about information you don't want others to see, you can control this.</p> 
<img src="/help/images/profile_field.jpg" alt="Example Profile field" title="Example Profile field" width="450" height="131" border="0">
...
<img src="/help/images/profile_access.jpg" alt="Profile access options" title="Profile access options" width="450" height="170" border="0">
...
<img src="/help/images/sidebar_profile.jpg" alt="Sidebar Profile" width="302" height="206" border="0">
<p>Remember to scroll to the end and click on <b>Save your profile</b>!</p>
<img src="/help/images/save.jpg" alt="Save your profile" title="Save your profile" width="249" height="48" border="0">
