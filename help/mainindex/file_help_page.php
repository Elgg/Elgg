...
<img src="{$url}help/images/files_one.jpg" alt="Start" title="Start" width="365" height="95" border="0" />
...
<img src="{$url}help/images/files_two.jpg" alt="Browse for file" title="Browse for file" width="419" height="72" border="0" />
<p><b>Step two:</b> Now enter a title <i>(recommended)</i> and short description <i>(optional)</i>.</p>
<img src="{$url}help/images/files_three.jpg" alt="Add a title and description" title="Add a title and description" width="380" height="92" border="0" />
<p><b>Step 3:</b> <i>(optional - default is public)</i> You can now set the 'Access Restriction' you want for this file.</p>
<img src="{$url}help/images/files_four.jpg" alt="Access" title="Access" width="350" height="80" border="0" />
<p><b>Step 4:</b> <i>(optional)</i> Now you might want to add some keywords (tags).</p>
<img src="{$url}help/images/files_six.jpg" alt="Keywords" title="Keywords" width="453" height="89" border="0" />
...
<img src="{$url}help/images/files_five.jpg" alt="disclaimer" title="disclaimer" width="455" height="43" border="0" />
...
<img src="{$url}help/images/files_seven.jpg" alt="disclaimer" title="disclaimer" width="500" height="200" border="0" />
