...
define(function(require) {
	...
	$(".embed-item").live('click', embed.insert);

	elgg.register_hook_handler('embed', 'editor', embed._deprecated_custom_insert_js);
	...
	$('.embed-wrapper .elgg-pagination a').live('click', embed.forward);

	$('.embed-section').live('click', embed.forward);

	$('.elgg-form-embed').live('submit', embed.submit);
	 ...
	 * @private
	 */
	embed._deprecated_custom_insert_js = function(hook, type, params, value) {
	 ...
	 * @return string
	 */
	embed.addContainerGUID = function(url) {
