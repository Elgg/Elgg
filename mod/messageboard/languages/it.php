...
return array(
	...
	'messageboard:desc' => "Questa è una lavagna. Puoi posizionarla sul tuo profilo così i tuoi amici possono lasciarti dei messaggi",
	...
	'messageboard:owner' => 'Lavagna di %s',
	'messageboard:owner_history' => 'Post di %s sulla lavagna di %s',

	/**
	 * Message board widget river
	 */
	'river:messageboard:user:default' => "%s ha postato sulla lavagna di %s",
...
Non puoi rispondere a questa email.",
	...
	'messageboard:somethingwentwrong' => "Qualcosa è andato storto durante il tentativo di salvare il messaggio, accertati che effettivamente hai inviato un messaggio.",
