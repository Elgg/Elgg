...
return [
	 ...
	 */
	'river:messageboard:user:default' => "%s plaatste een bericht in de berichtenbox van %s",
	...
	'messageboard:email:body' => "Hallo!

%s heeft op een bericht gereageerd. De reactie is:
...
Dit is een automatisch aangemaakt bericht. Je kunt hier niet op reageren.",
	...
	'messageboard:somethingwentwrong' => "Er is een fout opgetreden tijdens het opslaan van je bericht. Heb je wel een bericht geschreven?",
