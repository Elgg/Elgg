<?php
        ...
        */
        ...
        $data['profile:details'][] = array(__gettext("Who am I?"),"biography","longtext",__gettext("A short introduction for you."),"person");
        $data['profile:details'][] = array(__gettext("Introduction"),"biography","longtext",__gettext("A short introduction to this community."),"community");
