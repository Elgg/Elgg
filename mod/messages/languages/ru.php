...
return array(
	...
	*/
	...
	'messages:email:body' => "Вам написал(а) %s. Следующее:<br>
	<br>
	%s<br>
	<br>
	Для просмотра сообщения перейдите <a href=\"%s\">по ссылке</a>.<br>
	Что бы написать %s сообщение, перейдите <a href=\"%s\">по ссылке</a>.
	",
