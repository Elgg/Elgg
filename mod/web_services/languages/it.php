...
return array(
	...
	'APIException:MissingContentType' => "Tipo di contenuto mancate per dati d'invio",
	'SecurityException:APIAccessDenied' => "Spiacenti, l'API di accesso è stata disabilitata dall'amministratore.",
	'SecurityException:NoAuthMethods' => "Impossibile trovare un metodo di attenticazione in grado di autenticare questa richiesta API.",
