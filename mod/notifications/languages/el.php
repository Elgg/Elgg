...
return array(
	...
	'notifications:subscriptions:title' => 'Ειδοποιήσεις ανά χρήστη',
	'notifications:subscriptions:description' => 'Για να λαμβάνετε ειδοποιήσεις από τους φίλους σας (σε ατομική βάση) όταν δημιουργούν νέο περιεχόμενο, αναζητήστε τους παρακάτω και επιλέξτε τη μέθοδο ειδοποίησης που θα θέλατε να χρησιμοποιήσετε.',

	'notifications:subscriptions:groups:description' => 'Για να λαμβάνετε ειδοποιήσεις όταν προστίθεται νέο περιεχόμενο σε μια ομάδα που είστε μέλος της, βρείτε τις παρακάτω και επιλέξτε τη μέθοδο ειδοποίησης που θέλετε να χρησιμοποιήσετε.',
