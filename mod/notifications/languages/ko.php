...
return array(
	...
	'notifications:subscriptions:title' => '사용자 당 알림',
	'notifications:subscriptions:description' => '친구들이 새 글을 쓸 때마다 알림을 받으려면, 아래에서 그들을 찾아 사용하고 싶은 알림 방법을 선택하세요.',

	'notifications:subscriptions:groups:description' => '당신이 속해있는 모둠에 새로운 내용이 등록될 때 알림을 받고 싶으면, 아래에서 찾아 알림방법(들)을 설정하세요.',
