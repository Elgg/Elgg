...
foreach ($log_entries as $entry) {
	...
	$object_guid_link = elgg_view_url(elgg_http_add_url_query_elements('admin/administer_utilities/logbrowser', ['object_id' => $entry->object_id]), $entry->object_id);
	...
	$row .= elgg_format_element('td', ['class' => 'log-entry-guid'], $object_guid_link);
