...
return array(
	...
	'developers:help:display_errors' => "Por padrão, o arquivo .htaccess do Elgg suprime a exibição de erros fatais.",
	'developers:label:screen_log' => "Registrar na tela",
	'developers:help:screen_log' => "Exibe as saídas de elgg_log() e elgg_dump(), além da contagem de consultas ao Banco de Dados.",
