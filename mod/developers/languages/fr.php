...
return array(
	...
	'developers:help:screen_log' => "Ceci affiche la sortie de elgg_log() et le nombre de requêtes sur la base de données",
	...
	'developers:inspect:notifications' => 'Notifications',
