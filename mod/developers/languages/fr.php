...
return array(
	...
	'developers:help:system_cache' => 'Désactiver le fichier cache lors du développement. Autrement, les changements concernant vos plugins ne seront pas sauvés.',
...
⇥⇥⇥⇥⇥⇥⇥⇥⇥Cela peut casser les vues non HTML dans le principal affichage. Consulter developers_wrap_views() pour plus de détails. ",
	...
	'theme_sandbox:layouts' => 'Mise en page',
	'theme_sandbox:modules' => 'Modules',
	'theme_sandbox:navigation' => 'Navigation',
	'theme_sandbox:typography' => 'Typographie',

	'theme_sandbox:icons:blurb' => 'Utiliser <em>elgg_viw_icon(£name)</em> ou la classe elgg-icon-$name pour afficher les icônes. ',
