...
return array(
	...
	'developers:label:show_modules' => "在控制台显示AMD模块已装载",
...
⇥⇥⇥⇥⇥⇥⇥⇥⇥This can break non-HTML views in the default viewtype. See developers_wrap_views() for details.",
	...
	'developers:help:show_gear' => "视窗右下角的图标用于让卡发人员以管理权限设置及链接",
	...
	'theme_sandbox:icons:blurb' => '使用<em>elgg_view_icon($name)</em>显示图标',
