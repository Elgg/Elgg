...
return array(
	...
	'groups:unsubscribed' => 'Notifiche gruppo disattivate',
	...
	'groups:save_error' => 'Il gruppo non è stato salvato',
...
Visualizza e rispondi all\'argomento di discussione:
%s',
...
'%s ha risposto all\'argomento di discussione %s del gruppo %s:
...
%s',
	...
	'groupforumtopic:new' => "Nuovo commento",
	...
	'discussion:add' => 'Aggiungi argomento di conversazione',
	'discussion:latest' => 'Ultime conversazioni',
	'discussion:group' => 'Discussioni del gruppo',
	'discussion:none' => 'Nessuna conversazione',
	'discussion:reply:title' => 'Rispondi via %s',

	'discussion:topic:created' => 'L\'argomento di conversazione è stato creato',
	'discussion:topic:updated' => 'Argomento di conversazione aggiornato',
	'discussion:topic:deleted' => 'Argomento di conversazione cancellato',

	'discussion:topic:notfound' => 'Argomento di conversazione non trovato',
	'discussion:error:notsaved' => 'Impossibile salvare questo argomento',
	'discussion:error:missing' => 'Sia il titolo che il messaggio sono campi obbligatori',
	'discussion:error:permissions' => 'Non hai autorizzazioni per inviare questo comando',
	'discussion:error:notdeleted' => 'Non è stato possibile cancellare questo argomento di conversazione',

	'discussion:reply:edit' => 'Modifica risposta',
	'discussion:reply:deleted' => 'Risposta alla conversazione cancellata',
	'discussion:reply:error:notfound' => 'La risposta alla discussione non è stata trovata',
	'discussion:reply:error:notfound_fallback' => "Spiacenti, non abbiamo trovato la risposta specificata ma ti abbiamo portato alla pagina dell'argomento di discussione iniziale",
	'discussion:reply:error:notdeleted' => 'Non è stato possibile cancellare la risposta alla conversazione',
	...
	'groupspost:success' => 'Il tuo commento è stato pubblicato con successo',
	'groupspost:failure' => 'Problema durante il salvatagio della tua risposta',
	...
	'groups:topiccloseddesc' => 'Questo argomento è stato chiuso e non si accettano nuovi commenti.',
	'grouptopic:error' => 'Il tuo argomento non può essere creato. Per favore riprova o contatta l\'amministratore di sistema.',
	'groups:forumpost:edited' => "Post modificato con successo.",
	'groups:forumpost:error' => "Si è verificato un problema nel modificare il post.",
...
%s",
	...
	'river:create:object:groupforumtopic' => '%s ha aggiunto il nuovo argomento di discussione %s',
	'river:reply:object:groupforumtopic' => '%s ha risposto all\'argomento di discussione %s',
	...
	'grouppost:notdeleted' => 'Il post non può essere eliminato',
	 ...
	 * ecml
	 */
	'groups:ecml:discussion' => 'Conversazioni del gruppo',
