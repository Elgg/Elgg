...
return array(
	 ...
	 */
	'add:group:group' => "Stvori novu grupu",
	...
	'groups:edit:tools' => "Alati",
	'groups:edit:settings' => "Postavke",
	...
	// accessibility
	'groups:aria:label:group_search' => "Pretraži grupe",
	'groups:aria:label:search_in_group' => "Pretraži ovu grupu",
);
