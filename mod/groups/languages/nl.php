...
return array(
	...
	'groups:subscribed' => 'Groep notificaties aan',
	'groups:unsubscribed' => 'Groep notificaties uit',

	'groups:members:title' => 'Leden van %s',
	'groups:members:more' => "Bekijk alle leden",
	'groups:membership' => "Lidmaatschap",
	'groups:content_access_mode' => "Toegangsrechten van de groepsinhoud",
	'groups:content_access_mode:warning' => "Opgelet: Het veranderen van deze instelling heeft geen invloed op de toegangsrechten van de bestaande groepsinhoud.",
	'groups:content_access_mode:unrestricted' => "Geen restricties. Toegang hangt af van de instelling van de content.",
	...
	'discussion:topic:notify:summary' => 'Nieuw discussie onderwerp met de titel %s',
	'discussion:topic:notify:subject' => 'Nieuw discussie onderwerp: %s',
	'discussion:topic:notify:body' =>
'%s voegde een nieuw discussie onderwerp toe aan de groep %s:

Titel: %s

%s

Bekijk en reageer op het discussie onderwerp:
%s
',
...
'%s reageerde op het onderwerp %s in in de groep %s:
...
',
	...
	'groups:opengroup:membersonly' => "De inhoud van deze groep is enkel toegankelijk voor leden.",
	'groups:opengroup:membersonly:join' => 'Om lid te worden, klik op de "word lid" menu link.',
	...
	'discussion:reply:error:notfound' => 'Reactie op discussie niet gevonden',
