...
return array(
	...
	'groups:unsubscribed' => 'Notifications du groupe désactivées',

	'groups:members:title' => 'Les membres de %s',
	'groups:members:more' => "Voir tous les membres",
	'groups:membership' => "Type d'adhésion",
	'groups:content_access_mode' => "Accès au contenu du groupe",
	'groups:content_access_mode:warning' => "Attention : la modification de ce paramètre ne changera pas le niveau d'accès des contenus existant.",
