...
return array(
	...
	'groups:owned:user' => 'Donos das comunidades %s',
	...
	'groups:membershiprequests:pending' => 'Gerencia solicitação de inclusões (%s)',
	'groups:invitations' => 'Convites da Comunidade',
	'groups:invitations:pending' => 'Convites das comunidades (%s)',
	...
	'groups:content_access_mode' => "Acessibilidade do conteúdo da comunidade",
	'groups:content_access_mode:warning' => "Aviso: Alterando esta configuração não será mudada a permissão de acesso do conteúdo  existente da comunidade.",
	'groups:content_access_mode:unrestricted' => "Irrestrito - Acesso depende da configuração definida a nível de conteúdo.",
	'groups:content_access_mode:membersonly' => "Somente membros - Pessoas não associadas nunca poderão acessar o conteúdo da comunidade.",
	'groups:access' => "Permissões de acesso",
	'groups:owner' => "Proprietário",
	'groups:owner:warning' => "Aviso: se você alterar este valor, você não será mais o dono desta comunidade.",
	...
	'groups:widget:group_activity:title' => 'Atividade na comunidade',
	'groups:widget:group_activity:description' => 'Visualize a atividade em uma das suas comunidades',
	'groups:widget:group_activity:edit:select' => 'Selecione uma comunidade',
	'groups:widget:group_activity:content:noactivity' => 'Não existe nenhuma atividade neste grupo.',
	...
	'groups:nofeatured' => 'Nenhuma comunidade em destaque',
...
',
	...
	'groups:closedgroup:membersonly' => "Participação como membros desta comunidade é fechado e este conteúdo é acessível apenas para membros.",
	'groups:opengroup:membersonly' => "O conteúdo da comunidade é acessível apenas para membros.",
	'groups:opengroup:membersonly:join' => 'Para se tornar membro, selecione o link do menu "Entrar para comunidade"',
...
%s",
	...
	'groups:error:addedtogroup' => "Não foi possível adicionar %s na comunidade",
	'groups:add:alreadymember' => "%s já é um participante desta comunidade",
