...
$english = array(
	...
	'groups:walled' => "Restrict content access to members",
	'groups:walled:no' => "No - Access depends on content-level settings",
	'groups:walled:yes' => "Yes - Non-members can never view group content",
