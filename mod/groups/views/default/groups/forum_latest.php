...
<?php
    ...
    if($forum){
        foreach($forum as $f){
    	        ...
    	        echo "<div class=\"topic_title\"><p><a href=\"{$vars['url']}mod/groups/topicposts.php?topic={$f->guid}&group_guid={$vars['entity']->guid}\">" . $f->title . "</a></p> <p class=\"topic_replies\"><small>".elgg_echo('group:posts').": " . $count_annotations . "</small></p></div>";
