...
return array(
	...
	'thewire:form:body:placeholder' => "Dè tha dol?",
	
	/**
	 * The wire river
	 */
	'river:object:thewire:create' => "Phostaich %s brath ùr ris %s",
	'thewire:wire' => 'an uèir',

	/**
	 * Wire widget
	 */
	
	'widgets:thewire:description' => 'Seall na brathan-uèir as ùire',
	'thewire:num' => 'An àireamh de bhrathan-uìer a chithear',
	'thewire:moreposts' => 'Barrachd brathan-uèir',
	 ...
	 * Notifications
	 */
	'thewire:notify:summary' => 'Brath-uèir ùr: %s',
	'thewire:notify:subject' => "Brath-ùeir ùr bho %s",
	'thewire:notify:reply' => 'Dh\'fhàg %s beachd air brath a phost %s ris an uèir:',
	'thewire:notify:post' => 'Phost %sris an uèir:',
	'thewire:notify:footer' => "Seall agus fàg beachd air:\n %s",
