...
return array(
	 ...
	 * The wire river
	 */
	'river:object:thewire:create' => "%s a postat pe %s",
	'thewire:wire' => 'fir',
	...
	'widgets:thewire:description' => 'Afișează-ți ultimele postări de fir',
	'thewire:num' => 'Numărul de postări pentru afișare',
	'thewire:moreposts' => 'Mai multe postări de fir',
	 ...
	 * Notifications
	 */
	'thewire:notify:summary' => 'Postare de fir nouă: %s',
	'thewire:notify:subject' => "Postare de fir nouă de la %s",
	'thewire:notify:reply' => '%s a răspuns către %s pe fir:',
	'thewire:notify:post' => '%s a postat pe fir:',
	'thewire:notify:footer' => "Vezi și răspunde:/n%s",
