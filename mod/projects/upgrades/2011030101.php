<?php
/**
 * Move text of first annotation to project forum topic object and delete annotation
 *
 ...
 */
function projects_2011030101($topic) {
	...
	$annotation = $topic->getAnnotations('project_topic_post', 1);
	if (!$annotation) {
...
$batch = new ElggBatch('elgg_get_entities', $options, 'projects_2011030101', 100);
