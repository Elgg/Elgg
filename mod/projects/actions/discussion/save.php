...
if (!$container || !$container->canWriteToContainer(0, 'object', 'projectforumtopic')) {
...
if ($new_topic) {
	...
	$topic->subtype = 'projectforumtopic';
} else {
...
if ($new_topic) {
	...
	add_to_river('river/object/projectforumtopic/create', 'create', elgg_get_logged_in_user_guid(), $topic->guid);
} else {
