...
return array(
	...
	'install:welcome' => 'Hoşgeldiniz',
	'install:requirements' => 'Gereksinimler kontrolü',
	'install:database' => 'Veritabanı kurulumu',
	'install:settings' => 'Site yapılandırması',
	'install:admin' => 'Yönetici hesabı oluştur',
	'install:complete' => 'Tamamlandı',

	'install:next' => 'Sonraki',
	'install:refresh' => 'Tazele',
...
If you are ready to proceed, click the Next button.",
	'install:requirements:instructions:success' => "Sunucunuz gereksinimler kontrolünden geçti.",
	...
	'install:require:rewrite' => 'Web sunucusu',
	'install:require:settings' => 'Ayarlar dosyası',
	'install:require:database' => 'Veritabanı',
	...
	'install:database:label:dbuser' =>  'Veritabanı Kullanıcı Adı',
	'install:database:label:dbpassword' => 'Veritabanı Şifresi',
	'install:database:label:dbname' => 'Veritabanı Adı',
	'install:database:label:dbhost' => 'Veritabanı Sunucusu',
	'install:database:label:dbprefix' => 'Veritabanı Tablo Ön Eki',
	'install:database:label:timezone' => "Saat Dilimi",
	...
	'install:settings:label:sitename' => 'Site Adı',
	'install:settings:label:siteemail' => 'Site E-posta Adresi',
	'install:settings:label:wwwroot' => 'Site Bağlantısı',
	'install:settings:label:path' => 'Elgg Kurulum Dizini',
	'install:settings:label:dataroot' => 'Veri Dizini',
	'install:settings:label:language' => 'Site Dili',
	'install:settings:label:siteaccess' => 'Varsayılan Site Erişimi',
	'install:label:combo:dataroot' => 'Elgg creates data directory',

	'install:settings:help:sitename' => 'Yeni Elgg sitenizin adı',
	...
	'install:admin:label:displayname' => 'Görünen Ad',
	'install:admin:label:email' => 'E-posta Adresi',
	'install:admin:label:username' => 'Kullanıcı Adı',
	'install:admin:label:password1' => 'Şifre',
	'install:admin:label:password2' => 'Şifre Tekrarı',
	...
	'install:admin:password:mismatch' => 'Şifreler uyuşmalı.',
	'install:admin:password:empty' => 'Şifre boş olamaz.',
	'install:admin:password:tooshort' => 'Şifreniz çok kısa',
	...
	'install:complete:gotosite' => 'Siteye git',

	'InstallationException:UnknownStep' => '%s is an unknown installation step.',
	'InstallationException:MissingLibrary' => '%s yüklenemedi',
	...
	'install:success:database' => 'Veritabanı kuruldu.',
	'install:success:settings' => 'Site ayarları kaydedildi.',
	'install:success:admin' => 'Yönetici hesabı oluşturuldu.',

	'install:error:htaccess' => 'Bir .htaccess dosyası oluşturulamadı',
	'install:error:settings' => 'Ayarlar dosyası oluşturulamadı',
