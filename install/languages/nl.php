...
return array(
	...
	'install:change_language' => 'Wijzig taal',
...
Als je klaar bent on verder te gaan, klik op de Volgende knop.",
	...
	'install:footer:instructions' => "Installatie instructies",
	'install:footer:troubleshooting' => "Installatie troubleshooting",
...
2. Kopieer het bestand %s/settings.example.php naar elgg-config/settings.php en volg de instructies in het bestand om de database configuratie af te ronden',
	...
	'install:database:label:dbport' => 'Database poortnummer',
	'install:database:label:dbprefix' => 'Database table voorvoegsel',
	'install:database:label:timezone' => "Tijdzone",

	'install:database:help:dbuser' => 'De gebruiker die de volledige bevoegdheid heeft tot de database die je aangemaakt hebt voor Elgg',
	...
	'install:database:help:dbhost' => 'Hostnaam van de databaseserver (meestal localhost)',
	'install:database:help:dbport' => 'Poortnummer van de databaseserver (meestal 3306)',
	...
	'install:complete:admin_notice:custom_index' => 'We hebben de Front Page Demo plugin ingeschakeld om de startpagina mee te kunnen beheren. Je kunt dit hier %s configureren.',
	...
	'install:error:settings_mismatch' => 'De settings file waarde voor "%s" matched niet met de opgegeven $params. Verwacht: "%s" Werkelijk: "%s"',
	...
	'install:error:database_version' => 'Database moet minimaal versie %s zijn. Jouw server gebruikt versie %s.',
