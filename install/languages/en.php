...
If you are ready to proceed, click the Next button.",
	...
	'install:database:label:dbcreatepassword' => 'Database Superuser Password',
	...
	'install:database:label:dbencoding' => 'Database Character Set',
	'install:database:label:dbencoding:utf8' => 'UTF-8 (utf8: max 3 bytes)',
	'install:database:label:dbencoding:utf8mb4' => 'UTF-8 (utf8mb4: up to 4 bytes, only MySQL >= 5.5.3)',

	'install:database:help:dbcreateuser' => 'Superuser for your MySQL server used to create the new Elgg database - leave blank if the database has already been created (this information will NOT be stored anywhere in your Elgg installation)',
	'install:database:help:dbcreatepassword' => 'Password for the above superuser account (this information will NOT be stored anywhere in your Elgg installation)',
	'install:database:help:dbuser' => 'User that has full privileges to the MySQL database that you created for Elgg - if Elgg creates the database, it will also create this user and grant the corresponding privileges',
	...
	'install:database:help:dbencoding' => 'The character set of your data (use "utf8mb4" if possible for support of 4-byte characters)',
	...
	'install:error:utf8mb4' => 'MySQL must be version 5.5.3 or above in order to use UTF-8 with 4-byte support. Your server is using %s.',
