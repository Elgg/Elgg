...
2. Copy the file %s/settings.example.php to elgg-config/settings.php and follow the instructions in it for setting your database parameters.',
	...
	'install:database:help:dbuser' => 'User that has full privileges to the database that you created for Elgg',
	...
	'install:database:help:dbhost' => 'Hostname of the database server (usually localhost)',
	'install:database:help:dbport' => 'Port number of the database server (usually 3306)',
	...
	'install:error:database_version' => 'Database must be version %s or above. Your server is using %s.',
