...
If you are ready to proceed, click the Next button.",
	...
	'install:check:php:version' => 'Elgg requires PHP {0} or above. This server is using version {1}.',
	'install:check:php:extension' => 'Elgg requires the PHP extension {0}.',
	'install:check:php:extension:recommend' => 'It is recommended that the PHP extension {0} is installed.',
	...
	'install:check:php:arg_separator' => 'arg_separator.output must be & for Elgg to work and your server\'s value is {0}',
	...
	'install:admin:help:password1' => "Account password must be at least {0,number,integer} characters long",
	...
	'InstallationException:UnknownStep' => '{0} is an unknown installation step.',
	'InstallationException:MissingLibrary' => 'Could not load {0}',
	...
	'install:error:oldmysql' => 'MySQL must be version 5.0 or above. Your server is using {0}.',
	'install:error:nodatabase' => 'Unable to use database {0}. It may not exist.',
	...
	'install:error:requiredfield' => '{0} is required',
	'install:error:relative_path' => 'We don\'t think "{0}" is an absolute path for your data directory',
	'install:error:datadirectoryexists' => 'Your data directory {0} does not exist.',
	'install:error:writedatadirectory' => 'Your data directory {0} is not writable by the web server.',
	'install:error:locationdatadirectory' => 'Your data directory {0} must be outside of your install path for security.',
	'install:error:emailaddress' => '{0} is not a valid email address',
	...
	'install:warning:rewrite:unknown' => 'Your server does not support automatic testing of the rewrite rules and your browser does not support checking via JavaScript. You can continue the installation, but you may experience problems with your site. You can manually test the rewrite rules by clicking this link: <a href="{0}" target="_blank">test</a>. You will see the word success if the rules are working.',
