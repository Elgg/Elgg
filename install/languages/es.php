...
return array(
	...
	'install:welcome:instructions' => "¡Instalar Elgg tiene 6 pasos simples y leer esta bienvenida es el primero!

Si aún no lo has hecho, lee las instrucciones de instalación incluidas con Elgg (o haz clic en el enlace de instrucciones en la parte inferior de la página).

Si estás listo para continuar, haz clic en el botón Siguiente.",
	'install:requirements:instructions:success' => "Tu servidor pasó la verificación de requerimientos.",
	'install:requirements:instructions:failure' => "Tu servidor falló la verificación de requerimientos. Luego de solucionar los items enumerados debajo refresque esta página. Si necesita mas ayuda verifique los enlaces de solución de problemas al final de esta página.",
	'install:requirements:instructions:warning' => "Tu servidor pasó la verificación de requerimientos, pero hay al menos una advertencia. Le recomendamos que verifique la página de solución de problemas para mas información.",
	...
	'install:check:root' => 'Tu servidor web no tiene permiso para crear un archivo .htaccess en el directorio raíz de Elgg. Tienes dos opciones:

1. Cambiar los permisos en el directorio raíz.

2. Copia el archivo install/config/htaccess.dist a .htaccess',
	...
	'install:check:php:register_globals' => 'Debes desactivarse el registro de globales.',
	...
	'install:check:installdir' => 'Tu servidor web no tiene permiso para crear el archivo settings.php en el directorio de instalación. Tienes dos opciones:

1. Cambiar los permisos en el directorio elgg-config de tu instalación de Elgg

2. Copia el archivo %s/settings.example.php a elgg-config/settings.php y siga las instrucciones para configurar los parámetros de tu base de datos.',
	...
	'install:check:php:success' => "El PHP del servidor satisface todos los requerimientos de Elgg.",
	...
	'install:settings:instructions' => 'Necesitamos información sobre el sitio mientras configuramos Elgg. Si no has <a href="http://learn.elgg.org/en/stable/intro/install.html#create-a-data-folder" target="_blank">creado un directorio de datos</a> para Elgg, debes hacerlo ahora.',
	...
	'install:database:help:wwwroot' => 'La dirección de este sitio (normalmente Elgg la selecciona correctamnete)',
	...
	'install:settings:help:dataroot:apache' => 'Tienes la opción de que Elgg cree el directorio o de seleccionar uno que ya hayas creado (se validarán los permisos sobre este directorio cuando presione el botón de siguiente)',
	...
	'install:complete:admin_notice' => '¡Bienvenido a tu sitio Elgg! Para más opciones, vea %s.',
	...
	'InstallationException:CannotLoadSettings' => 'Elgg no pudo cargar el archivo de configuración. No existe o hay un problema de permisos de archivos.',
	...
	'install:error:settings_mismatch' => 'El valor del archivo de configuración para "%s" no coincide con los $params dados.',
	'install:error:databasesettings' => 'No se pudo conectar a la base de datos con la información provista',
	'install:error:database_prefix' => 'Caracteres inválidos en el prefijo de base de datos',
	...
	'install:error:relative_path' => 'No pensamos que "%s" sea una ruta absoluta de tu directorio de datos',
	...
	'install:error:rewrite:allowoverride' => "La prueba de reescritura falló y la causa más probable es que AllowOverride no está configurado en All para el directorio de Elgg. Esto evita que Apache procese el archivo .htaccess que contiene las reglas de reescritura.
\n\nUna causa menos probable es que Apache esté configurado con un alias para su directorio Elgg y usted necesite configurar RewriteBase en su .htaccess. Hay más instrucciones en el archivo .htaccess en su directorio Elgg.",
	...
	'install:error:rewrite:unknown' => 'uff. No podemos saber qué tipo de servidor web se encuentra ejecutando y falló la reescritura de reglas. No podemos ofrecer ninguna ayuda específica. Por favor verifique el enlace de solución de problemas.',
	...
	'exception:contact_admin' => 'Se ha producido un error irrecuperable y se ha registrado. Si usted es el administrador del sitio, verifique su archivo de configuración; de lo contrario, comuníquese con el administrador del sitio con la siguiente información:',
