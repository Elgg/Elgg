...
Se estás listo para continuar, preme o botón de «Seguinte».",
	...
	'install:check:root' => 'O servidor web non ten permisos para crear un ficheiro «.htaccess» no cartafol principal de Elgg. Ten dúas opcións:
		...
		2. Copiar o ficheiro «install/config/htaccess.dist» a «.htaccess».',
...
Outra causa, menos probábel, é que Apache estea configurado con un alias para o cartafol de Elgg, e entón terá que definir a opción «RewriteBase» no seu ficheiro «.htaccess». Atopará instrucións máis detalladas no ficheiro «.htaccess» do cartafol de Elgg.",
	'install:error:rewrite:htaccess:write_permission' => 'O servidor web non ten permisos para crear o ficheiro «.htaccess» no cartafol de Elgg. Ten que copiar manualmente o ficheiro «install/config/htaccess.dist» a «.htaccess» ou cambiar os permisos do cartafol.',
	...
	'install:error:rewrite:htaccess:cannot_copy' => 'Non foi posíbel crear o ficheiro «.htaccess» debido a un erro descoñecido. Ten que copiar manualmente o ficheiro «install/config/htaccess.dist» en «.htaccess» no cartafol de Elgg',
