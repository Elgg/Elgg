...
return array(
	...
	'install:requirements' => 'Проверка требований',
	'install:database' => 'Установка базы данных',
	'install:settings' => 'Настройка сайта',
...
If you are ready to proceed, click the Next button.",
	'install:requirements:instructions:success' => "Ваш сервер прошёл проверку требований.",
