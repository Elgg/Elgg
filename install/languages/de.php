...
Wenn Du bereits bist, um fortzufahren, klicke auf den 'Weiter'-Knopf.",
	...
	'install:check:root' => 'Aufgrund fehlender Schreibberechtigung ist es leider nicht möglich, auf Deinem Server im Hauptverzeichnis der Elgg-Installation die Datei .htaccess zu erzeugen. Du hast zwei Möglichkeiten:
		...
		2. Lege die Datei .htaccess selbst an, indem Du die Datei namens install/config/htaccess.dist zu .htaccess kopierst.',
	...
	'install:error:rewrite:htaccess:cannot_copy' => 'Beim Erzeugen der Datei .htaccess im Elgg-Installationsverzeichnis ist ein unbekannter Fehler aufgetreten. Du mußt die Datei .htaccess selbst anlegen, indem Du die Datei namens install/config/htaccess.dist zu .htaccess kopierst.',
