...
Si vous êtes prêt à commencer, cliquez sur le bouton Suivant.",
	...
	'install:check:installdir' => 'Votre serveur web n\'a pas la permission de créer le fichier .env.php dans le répertoire d\'installation. Vous avez deux possibilités :

1. Modifier les permissions du dossier elgg-config de votre installation d\'Elgg

2. Copier le fichier %s/.env.php.example dans elgg-config/.env.php et suivre les instructions à l\'intérieur du fichier pour définir les paramètres de la base de données.',
	...
	'install:error:readsettingsphp' => 'Impossible de lire le fichier /elgg-config/.env.php.example',
	'install:error:writesettingphp' => 'Impossible d\'écrire dans le fichier /elgg-config/.env.php',
