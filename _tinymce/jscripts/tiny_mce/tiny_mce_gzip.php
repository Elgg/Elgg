<?php
// NB: THIS FILE HAS CHANGED FROM UPSTREAM
 ...
 */
	...
	$suffix = getParam("suffix", "") == "_src" ? "_src" : ""; // CHANGED FROM UPSTREAM
	$cachePath = realpath($CFG->dataroot . "cache"); // Cache path, this is where the .gz files will be stored // CHANGED FROM UPSTREAM
