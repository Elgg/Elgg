...
/**
 * WARNING: API IN FLUX. DO NOTE USE DIRECTLY.
 * 
...
class ElggPluginHookService {
	 ...
	 *
	 * @return mixed The return value of the last handler callback called
	 *
     ...
     * @todo Throw exceptions for invalid arguments and remove this return value.
     *
