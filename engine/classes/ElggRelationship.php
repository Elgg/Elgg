...
class ElggRelationship extends \ElggData {
	...
	public function save() {
		if ($this->id > 0) {
			throw new LogicException('Relationships can not be updated. Delete and create a new one');
		}

		if (!_elgg_services()->relationshipsTable->add($this)) {
			return false;
		};
