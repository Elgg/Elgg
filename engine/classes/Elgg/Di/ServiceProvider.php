 ...
 * @property-read \Elgg\Search\SearchService               $searchService
...
class ServiceProvider extends \Elgg\Di\DiContainer {
	...
	public function __construct(\Elgg\Config $config) {
		...
		$this->setFactory('searchService', function(ServiceProvider $c) {
			return new \Elgg\Search\SearchService($c->config, $c->hooks, $c->logger);
		});
