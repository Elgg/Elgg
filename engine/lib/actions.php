 ...
 *
 * Action tokens can be manually generated by using {@link _elgg_generate_action_token()}.
 *
...
function _elgg_init_site_secret() {
	...
	if (_elgg_datalist_set('__site_secret__', $secret)) {
		return $secret;
	}
...
function _elgg_actions_init() {
	...
	elgg_register_plugin_hook_handler('action', 'all', '_elgg_ajax_action_hook');
	elgg_register_plugin_hook_handler('forward', 'all', '_elgg_ajax_forward_hook');
}

elgg_register_event_handler('init', 'system', '_elgg_actions_init');
