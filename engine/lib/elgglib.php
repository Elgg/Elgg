...
function forward($location = "", $reason = 'system') {
	if (!headers_sent($file, $line)) {
		...
		throw new SecurityException("Redirect could not be issued due to headers already being sent. Halting execution for security. Output started in file " . $file . " at line " . $line . ". Search http://docs.elgg.org/ for more information.");
	}
}
