...
class ElggCorePluginsAPITest extends \ElggCoreUnitTest {
	...
	public function __construct() {
		...
		$this->manifest18 = new \ElggPluginManifest(elgg_get_config('path') . 'engine/tests/test_files/plugin_18/manifest.xml', 'plugin_test_18');
		
		$this->package18 = new \ElggPluginPackage(elgg_get_config('path') . 'engine/tests/test_files/plugin_18');
	}
	...
	public function testElggPluginManifestFromFile() {
		$file = elgg_get_config('path') . 'engine/tests/test_files/plugin_18/manifest.xml';
	...
	public function testElggPluginManifest18() {
		$manifest_array = array(
			...
			'requires' => array(
				...
				array('type' => 'php_version', 'version' => '7.0'),
	...
	public function testElggPluginManifestGetRequires() {
		$requires = array(
			...
			array('type' => 'php_version', 'version' => '7.0', 'comparison' => 'ge'),
