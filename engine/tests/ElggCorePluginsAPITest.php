...
class ElggCorePluginsAPITest extends \ElggCoreUnitTest {
	...
	public function __construct() {
		...
		$this->manifest18 = new \ElggPluginManifest(_elgg_config()->path . 'engine/tests/test_files/plugin_18/manifest.xml', 'plugin_test_18');
		
		$this->package18 = new \ElggPluginPackage(_elgg_config()->path . 'engine/tests/test_files/plugin_18');
	}

	// generic tests
	public function testElggPluginManifestFromString() {
		$manifest_file = file_get_contents(_elgg_config()->path . 'engine/tests/test_files/plugin_18/manifest.xml');
	...
	public function testElggPluginManifestFromFile() {
		$file = _elgg_config()->path . 'engine/tests/test_files/plugin_18/manifest.xml';
