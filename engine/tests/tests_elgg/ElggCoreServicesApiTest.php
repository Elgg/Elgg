...
class ElggCoreServicesApiTest extends ElggTestCase
{
...
// expose_function
	public function testExposeFunctionNoMethod() 
	{
		try {
			...
			$this->assertEquals($e->getMessage(), elgg_echo('InvalidParameterException:APIMethodOrFunctionNotSet'));
		}
	}
	...
	public function testExposeFunctionBadParameters() 
	{
		try {
			...
			$this->assertInstanceOf('InvalidParameterException', $e);
			$this->assertEquals($e->getMessage(), sprintf(elgg_echo('InvalidParameterException:APIParametersArrayStructure'), 'test'));
		}
	}
	...
	public function testExposeFunctionBadHttpMethod() 
	{
		try {
			...
			$this->assertInstanceOf('InvalidParameterException', $e);
			$this->assertEquals($e->getMessage(), sprintf(elgg_echo('InvalidParameterException:UnrecognisedHttpMethod'), 'BAD', 'test'));
		}
	}
	...
	public function testExposeFunctionSuccess() 
	{
		...
		$this->assertEquals($method, $API_METHODS['test']);
	}
...
// unexpose_function
	public function testUnexposeFunction() 
	{
		...
		$this->assertEquals(array(), $API_METHODS);
	} 
...
// authenticate_method
	public function testAuthenticateMethodNotImplemented() 
	{
		try {
			...
			$this->assertInstanceOf('APIException', $e);
			$this->assertEquals($e->getMessage(), sprintf(elgg_echo('APIException:MethodCallNotImplemented'), 'BAD'));
		}				
	}
	...
	public function testAuthenticateMethodApiAuth() 
	{
		...
		try {
			...
			$this->assertInstanceOf('APIException', $e);
			$this->assertEquals($e->getMessage(), elgg_echo('APIException:APIAuthenticationFailed'));
		}				
	}
...
// execute_method
	...
	public function testExecuteMethodNonCallable() 
	{
		...
		try {
			...
			$this->assertInstanceOf('APIException', $e);
			$this->assertEquals($e->getMessage(), sprintf(elgg_echo('APIException:FunctionDoesNotExist'), 'test'));
		}				
	}
	...
	public function testExecuteMethodWrongMethod() 
	{
		...
		try {
			...
			$this->assertInstanceOf('CallException', $e);
			$this->assertEquals($e->getMessage(), sprintf(elgg_echo('CallException:InvalidCallMethod'), 'test', 'POST'));
		}						
	}
...
// verify parameters
	public function testVerifyParametersTypeNotSet() 
	{
		...
		try {
			...
			$this->assertInstanceOf('APIException', $e);
			$this->assertEquals($e->getMessage(), sprintf(elgg_echo('APIException:InvalidParameter'), 'param1', 'test'));
		}						
	}
	...
	public function testVerifyParametersMissing() 
	{
		...
		try {
			...
			$this->assertInstanceOf('APIException', $e);
			$this->assertEquals($e->getMessage(), sprintf(elgg_echo('APIException:MissingParameterInMethod'), 'param1', 'test'));
		}						
	}
	...
	public function testSerialiseParameters() 
	{
		...
		$s = serialise_parameters('test', $parameters);
		$this->assertEquals($s, ",array('0'=>'one','1'=>'two')");

		// associative array of strings
		$this->registerFunction(false, false, array('param1' => array('type' => 'array')));
		$parameters = array('param1' => array('first' => 'one', 'second' => 'two'));
		$s = serialise_parameters('test', $parameters);
		$this->assertEquals($s, ",array('first'=>'one','second'=>'two')");

		// indexed array of strings
		$this->registerFunction(false, false, array('param1' => array('type' => 'array')));
		$parameters = array('param1' => array(1, 2));
		$s = serialise_parameters('test', $parameters);
		$this->assertEquals($s, ",array('0'=>'1','1'=>'2')");
...
// api key methods
	...
	public function testApiAuthKeyNoKey() 
	{
		try {
			...
			$this->assertInstanceOf('APIException', $e);
			$this->assertEquals($e->getMessage(), elgg_echo('APIException:MissingAPIKey'));
		}
	}
	...
	public function testApiAuthKeyBadKey() 
	{
		...
		try {
			...
			$this->assertInstanceOf('APIException', $e);
			$this->assertEquals($e->getMessage(), elgg_echo('APIException:BadAPIKey'));
		}
	}
