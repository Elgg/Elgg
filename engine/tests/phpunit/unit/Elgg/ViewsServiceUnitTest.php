...
class ViewsServiceUnitTest extends \Elgg\UnitTestCase {
	...
	public function testCanSetViewPathsViaSpec() {
		$this->views->mergeViewsSpec([
			'default' => [
				'hello.js' => $this->getTestFilePath('views/default/js/static.js'),
				'hello/world.js' => [$this->getTestFilePath('views/default/js/interpreted.js.php')],
			],
		]);
	...
	public function testCanSetViewsDirs() {
		$this->views->setViewDir('static.css', $this->getTestFilePath('views2/'));
