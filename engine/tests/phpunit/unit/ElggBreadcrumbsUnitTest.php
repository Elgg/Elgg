...
class ElggBreadcrumbsUnitTest extends \Elgg\UnitTestCase {
	...
	public function testCrumbsCanBePushed() {
		...
		$this->assertEquals([
			['title' => 'title 1', 'link' => null],
			['title' => 'title 2', 'link' => 'path2']
	...
	public function testCrumbsCanBePopped() {
		...
		$this->assertEquals(['title' => 'title 2', 'link' => 'path2'], elgg_pop_breadcrumb());

		$this->assertEquals([
			['title' => 'title 1', 'link' => null],
				], elgg_get_breadcrumbs());

		$this->assertEquals(['title' => 'title 1', 'link' => null], elgg_pop_breadcrumb());
