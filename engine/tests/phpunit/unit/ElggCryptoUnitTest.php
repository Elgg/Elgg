...
class ElggCryptoUnitTest extends \Elgg\UnitTestCase {
	...
	protected function setUp() {
		...
		$this->stub->expects($this->any())
				...
				->will($this->returnCallback([$this, 'mock_getRandomBytes']));
	}
	...
	function provider() {
		return [
			[32, null, 'kwG37f3ds_7awuiaL52mVWXud9dqT1GF'],
			[32, \ElggCrypto::CHARS_HEX, '9301b7edfdddb3fedac2e89a2f9da655'],
			[32, \ElggCrypto::CHARS_PASSWORD, 'kl4lmjwyrpyh6rpqct3rkd9zvxwvqww8'],
			[32, "0123456789", "78181215379307389761767024720714"],
		];
	}
