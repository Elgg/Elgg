...
class ElggCorePluginsAPITest extends \Elgg\LegacyIntegrationTestCase {
	...
	public function setUp() {
		...
		$this->manifest18 = new \ElggPluginManifest($this->getTestFilePath('plugin_18/manifest.xml'), 'plugin_test_18');
		
		$this->package18 = new \ElggPluginPackage($this->getTestFilePath('plugin_18'));
	}

	// generic tests
	public function testElggPluginManifestFromString() {
		$manifest_file = file_get_contents($this->getTestFilePath('plugin_18/manifest.xml'));
	...
	public function testElggPluginManifestFromFile() {
		$file = $this->getTestFilePath('plugin_18/manifest.xml');
	...
	public function testElggPluginManifest18() {
		$manifest_array = [
			...
			'requires' => [
				['type' => 'elgg_release', 'version' => '1.8-svn'],
				['type' => 'php_extension', 'name' => 'gd'],
				['type' => 'php_ini', 'name' => 'short_open_tag', 'value' => 'off'],
				['type' => 'php_version', 'version' => '5.6'],
				['type' => 'php_extension', 'name' => 'made_up', 'version' => '1.0'],
				['type' => 'plugin', 'name' => 'fake_plugin', 'version' => '1.0'],
				['type' => 'plugin', 'name' => 'profile', 'version' => '1.0'],
				['type' => 'plugin', 'name' => 'profile_api', 'version' => '1.3', 'comparison' => 'lt'],
				['type' => 'priority', 'priority' => 'after', 'plugin' => 'profile'],
			],

			'screenshot' => [
				['description' => 'Fun things to do 1', 'path' => 'graphics/plugin_ss1.png'],
				['description' => 'Fun things to do 2', 'path' => 'graphics/plugin_ss2.png'],
			],
			
			'contributor' => [
				['name' => 'Evan Winslow', 'email' => 'evan@elgg.org', 'website' => 'http://evanwinslow.com/', 'username' => 'ewinslow', 'description' => "Description of Evan's role in the project"],
				['name' => 'Cash Costello', 'email' => 'cash@elgg.org', 'description' => "Description of Cash's role in the project"],
			],
			...
			'conflicts' => [
				['type' => 'plugin', 'name' => 'profile_api', 'version' => '1.0']
			],

			'provides' => [
				['type' => 'plugin', 'name' => 'profile_api', 'version' => '1.3'],
				['type' => 'php_extension', 'name' => 'big_math', 'version' => '1.0']
			],

			'suggests' => [
				['type' => 'plugin', 'name' => 'facebook_connect', 'version' => '1.0'],
			],
	...
	public function testElggPluginManifestGetRequires() {
		$requires = [
			['type' => 'elgg_release', 'version' => '1.8-svn', 'comparison' => 'ge'],
			['type' => 'php_extension', 'name' => 'gd', 'version' => '', 'comparison' => '='],
			['type' => 'php_ini', 'name' => 'short_open_tag', 'value' => 0, 'comparison' => '='],
			['type' => 'php_version', 'version' => '5.6', 'comparison' => 'ge'],
			['type' => 'php_extension', 'name' => 'made_up', 'version' => '1.0', 'comparison' => '='],
			['type' => 'plugin', 'name' => 'fake_plugin', 'version' => '1.0', 'comparison' => 'ge'],
			['type' => 'plugin', 'name' => 'profile', 'version' => '1.0', 'comparison' => 'ge'],
			['type' => 'plugin', 'name' => 'profile_api', 'version' => '1.3', 'comparison' => 'lt'],
			['type' => 'priority', 'priority' => 'after', 'plugin' => 'profile'],
		];
	...
	public function testElggPluginManifestGetSuggests() {
		$suggests = [
			['type' => 'plugin', 'name' => 'facebook_connect', 'version' => '1.0', 'comparison' => 'ge'],
		];
	...
	public function testElggPluginManifestGetContributors() {
		$contributors = [
			['name' => 'Evan Winslow', 'email' => 'evan@elgg.org', 'website' => 'http://evanwinslow.com/', 'username' => 'ewinslow', 'description' => "Description of Evan's role in the project"],
			['name' => 'Cash Costello', 'email' => 'cash@elgg.org', 'website' => '', 'username' => '', 'description' => "Description of Cash's role in the project"],
		];
	...
	public function testElggPluginManifestGetProvides() {
		$provides = [
			['type' => 'plugin', 'name' => 'profile_api', 'version' => '1.3'],
			['type' => 'php_extension', 'name' => 'big_math', 'version' => '1.0'],
			['type' => 'plugin', 'name' => 'plugin_18', 'version' => '1.0']
		];
