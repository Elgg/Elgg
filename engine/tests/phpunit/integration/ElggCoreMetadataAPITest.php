 ...
 * @subpackage Test
 */
class ElggCoreMetadataAPITest extends \Elgg\LegacyIntegrationTestCase {
	...
	public function testElggGetEntitiesFromMetadata() {
		...
		$options = ['metadata_names' => 'metaUnitTest', 'metadata_values' => 'Tested', 'limit' => 10, 'metadata_case_sensitive' => true];
		...
		$options = ['metadata_names' => 'metaUnitTest', 'metadata_values' => 'Tested', 'limit' => 10, 'metadata_case_sensitive' => false];
