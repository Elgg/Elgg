 ...
 * @group ElggBatch
 */
class ElggBatchTest extends \Elgg\LegacyIntegrationTestCase {
	...
	public function testElggBatchReadHandlesBrokenEntities() {
		...
		$this->assertEqual([$guids[0], $guids[6], $guids[7]], $entities_visited);
	...
	public function testElggBatchDeleteHandlesBrokenEntities() {
		...
		// The broken entities should not have been visited
		$this->assertEqual($entities_visited, [$guids[0], $guids[6], $guids[7]]);
