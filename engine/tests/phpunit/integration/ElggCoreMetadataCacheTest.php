 ...
 * @subpackage Test
 */
class ElggCoreMetadataCacheTest extends \Elgg\LegacyIntegrationTestCase {
	...
	public function testPopulateFromEntities() {
		...
		$this->cache->clearAll();
		$this->cache->populateFromEntities([$this->guid1, $this->guid2]);
	...
	public function testFilterHeavyEntities() {
		...
		$this->obj2->setMetadata($this->name, [$big_str, $big_str]);

		$guids = [$this->guid1, $this->guid2];
		$expected = [$this->guid1];
