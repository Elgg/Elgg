 ...
 * @group UploadService
 */
class UploadServiceTest extends \Elgg\TestCase {

	/**
	 *
	 * @var type @var \ElggUser
	 */
	private $user;
	...
	public function testCanSaveUploadToElggFile() {
		...
		$file = $uploaded_file->toElggFile();

		$this->assertInstanceOf(ElggFile::class, $file);
		$this->assertTrue($file->exists());
		$this->assertEquals($this->user->guid, $file->owner_guid);
