...
* ``blog_ecml_views_hook`` changed to ``Elgg\Blog\ECML::getViews``
...
* ``bookmarks_ecml_views_hook`` changed to ``Elgg\Bookmarks\ECML::getViews``
...
* ``groupprofile_ecml_views_hook`` changed to ``Elgg\Groups\ECML::getViews``
...
* ``messages_ecml_views_hook`` changed to ``Elgg\Messages\ECML::getViews``
...
* ``pages_ecml_views_hook`` changed to ``Elgg\Pages\ECML::getViews``
...
* ``profile_ecml_views_hook`` changed to ``Elgg\Profile\ECML::getViews``
