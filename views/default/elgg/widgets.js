define(function (require) {
	...
	/**
	 * Bind DOM events (only run once)
	 *
	 * @return void
	 */
	widgets.bindEvents = function () {
		if (typeof widgets.eventsBound === 'undefined') {
			$(document).on('click', '.elgg-widgets-add-panel li.elgg-state-available', widgets.add);
