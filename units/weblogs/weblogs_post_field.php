...
/*            
            $clickToAdd = __gettext("Click here to post to this weblog."); // gettext variable
            $title = <<< END
...
END;
            ...
            $hide = __gettext("Click here to hide this form."); // gettext variable
            $body .= <<< END
...
END;
            ...
            global $page_owner;
            $clickToAdd = __gettext("Click here to post to this weblog.");
