				...
				if ($result == 0) {
					$run_result = "
						<form action=\"".url . $_SESSION['username']."/friends/\" method=\"post\" style=\"display: inline\">
							...
							<input type=\"image\" src=\"".url."_friends/gfx/friend.gif\" border=\"0\" width=\"17\" height=\"18\" alt=\"Friend\" title=\"Friend\" onClick=\"return confirm('Are you sure you want to add this user to your friends list?')\" />
						</form>";
				} else {
					$run_result = "
						<form action=\"".url.$_SESSION['username']."/friends/\" method=\"post\" style=\"display: inline\">
							...
							<input type=\"hidden\" name=\"friend_id\" value=\"$user_id\" />
							<input type=\"image\" src=\"".url."_friends/gfx/unfriend.gif\" border=\"0\" width=\"17\" height=\"18\" alt=\"Un-Friend\" title=\"Un-Friend\" onClick=\"return confirm('Are you sure you want to remove this user from your friends list?')\"/>
						</form>";
				}
			}
