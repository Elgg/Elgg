...
$PHPTHUMB_CONFIG['cache_directory'] = $CFG->dataroot . 'cache/phpThumb/';
...
$PHPTHUMB_CONFIG['cache_maxfiles'] = 10000;             // delete least-recently-accessed cached thumbnails when more than [500] cached files are present (value is maximum number of cached files to keep)
...
$PHPTHUMB_CONFIG['cache_prefix'] = '';                         // allow phpThumb to share 1 set of cached files even if accessed under different servername/domains on same server
...
if (strtoupper(substr(PHP_OS, 0, 3)) == 'WIN') {
    ...
    //$PHPTHUMB_CONFIG['imagemagick_path'] = 'C:/ImageMagick-6.2.5-Q16/convert.exe';
